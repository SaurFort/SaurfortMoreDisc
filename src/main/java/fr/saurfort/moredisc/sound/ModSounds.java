...
public class ModSounds {
    ...
    public static final RegistryObject<SoundEvent> HEART_AFIRE = SOUNDS.register("disc.heart_afire", () -> new SoundEvent(new ResourceLocation(Reference.MOD_ID, "more.heart_afire")));

...
public class RecipeGenerator extends RecipeProvider {
    ...
    protected void buildShapelessRecipes(Consumer<IFinishedRecipe> consumer) {
        ...
        // smelting
        CookingRecipeBuilder.smelting(Ingredient.of(Items.MUSIC_DISC_11), ModItem.DARKNESS.get(), 0.10f, 200).unlockedBy("has_disc11", has(Items.MUSIC_DISC_11)).save(consumer);
    }
}
